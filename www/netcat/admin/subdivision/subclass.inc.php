...
#######################################################################
    ...
    function  ActionForm($SubClassID, $phase, $type) {
      ...
      WHERE `Class_ID` = '" . ($Class_Template_ID ? $Class_Template_ID : $ClassID ? $ClassID : $selected_value) . "'");
        ...
        $fieldsets->new_fieldset('main_info', CONTROL_CONTENT_CATALOUGE_FUNCS_CATALOGUEFORM_MAININFO, CONTROL_CONTENT_CATALOUGE_FUNCS_CATALOGUEFORM_MAININFO)->add(nc_sub_class_get_main_info($Array, $classInfo, $wsts_msg, $field));
...
function nc_sub_class_get_classInfo($perm, $Array, $classTemplatesArr, $edit_template_select, $admin_template_select) {
    ...
    if (!empty($classTemplatesArr)) {
        ...
        $classInfo .= "</select>
                    ...
                    ".($edit_template_select ? "<div>$edit_template_select</div><br><div>$admin_template_select</div>" : '')."
                </div>";
    }
